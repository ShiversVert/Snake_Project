...
def get_write_id_packet(servo_id, value):
    """
    Get a packet to set the ID of a servo.

    :param id: The id of the servo to change.
    :param value: The value for the new ID.
    :returns: A packet, in the form of a list of bytes.

    """

    return get_write_packet_1b(servo_id, registers.ID, value)
